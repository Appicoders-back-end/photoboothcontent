    ...
    <header class="header white-bg">
            ...
            <ul class="nav top-menu">
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="{{asset('admin_assets')}}/img/avatar-mini.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="{{asset('admin_assets')}}/img/avatar-mini2.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="{{asset('admin_assets')}}/img/avatar-mini3.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar" src="{{asset('admin_assets')}}/img/avatar-mini4.jpg"></span>
                                <span class="subject">
        ...
        <div class="top-nav ">
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" src="{{asset('admin_assets')}}/img/avatar1_small.jpg">
    ...
    <div class="sb-slidebar sb-right sb-style-overlay">
        ...
        <ul class="quick-chat-list">
            <li class="online">
                <div class="media">
                    <a href="#" class="">
                        <img alt="" src="{{asset('admin_assets')}}/img/chat-avatar2.jpg" class="mr-3 rounded-circle">
                    </a>
            ...
            <li class="online">
                <div class="media">
                    <a href="#" class="">
                        <img alt="" src="{{asset('admin_assets')}}/img/chat-avatar.jpg" class="mr-3 rounded-circle">
                    </a>
                    <div class="media-body">
            ...
            <li class="online">
                <div class="media">
                    <a href="#" class="">
                        <img alt="" src="{{asset('admin_assets')}}/img/pro-ac-1.png" class="mr-3 rounded-circle">
                    </a>
                    <div class="media-body">
                        <div class="media-status">
            ...
            <li class="online">
                <div class="media">
                    <a href="#" class="">
                        <img alt="" src="{{asset('admin_assets')}}/img/avatar1.jpg" class="mr-3 rounded-circle">
                    </a>
                    <div class="media-body">
            ...
            <li class="online">
                <div class="media">
                    <a href="#" class="">
                        <img alt="" src="{{asset('admin_assets')}}/img/mail-avatar.jpg" class="mr-3 rounded-circle">
                    </a>
                    <div class="media-body">
                        <div class="media-status">
