...
{{--                        <input required type="email" class="form-control rounded-0 my-3" name="email" value="{{ auth()->user()->email??'' }}" placeholder="Email">--}}
                        <input required type="text" minlength="10" maxlength="10" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control rounded-0 my-3" name="phone_number" min="10" value="{{ old('phone_number') }}"  placeholder="Phone Number">
