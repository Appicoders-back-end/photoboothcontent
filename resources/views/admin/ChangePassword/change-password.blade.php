                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('admin.update_password')}}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="confirm_password" id="confirm_password" autocomplete="off" placeholder="Confirm Password">
                                <span toggle="#password-field" class="fa fa-fw fa-eye-slash field_icon toggle-c-password"></span>
                            </div>
                            <button type="submit" class="btn btn-sm btn-success">Save</button>
                            {{--          <a href="{{ route('admin.change_password') }}" class="btn btn-secondary">Cancel</a>--}}
                        </form>
                    </div>
                </section>
            </div>
