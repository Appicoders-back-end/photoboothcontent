                        ...
                        <div class="col-lg-12 mb-4">
                            <form action="{{ route('payment-methods.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="cardName" name="card_holder_name" value="{{ old('card_holder_name') }}" placeholder="John Doe">
                                </div>
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="expiryDate" class="form-label">Expiry Date</label>
                                        <input type="date" class="form-control" id="expiryDate" name="exp_date" value="{{ old('exp_date') }}" placeholder="MM/YY">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="cvv" class="form-label">CVV</label>
                                        <input type="text" class="form-control" id="cvv" name="cvc" value="{{ old('cvc') }}" placeholder="123">
                                    </div>
                                </div>
